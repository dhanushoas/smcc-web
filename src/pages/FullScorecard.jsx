...
const FullScorecard = () => {
    ...
    const downloadPDF = () => {
        ...
        match.innings.forEach((inn, idx) => {
            ...
            if (bowlingTeam) {
                autoTable(doc, {
                    ...
                    body: bowlingTeam.map(b => [b.player, b.overs, b.maidens, b.runs, b.wickets, b.economy]),
                    theme: 'grid',
        ...
        doc.save(`${match.teamA}_vs_${match.teamB}_Scorecard.pdf`);
    };
    ...
    return (
        <Container className="py-4 scorecard-page">
            <Card className="border-0 shadow-sm overflow-hidden mb-4">
                <div className="bg-cric-dark text-white px-4 py-3 d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <Button as={Link} to="/" variant="link" className="text-white text-decoration-none p-0 ps-2">✕ {language === 'en' ? 'Close' : 'மூடு'}</Button>
                    </div>
                </div>

                <Card.Body className="p-0">
                    <div className="p-4 border-bottom">
                        <h4 className="fw-black mb-1 text-uppercase letter-spacing-1">{match.teamA} vs {match.teamB}</h4>
                                ...
                                <div className="innings-list">
                                    {match.innings.map((inn, idx) => (
                                        <div key={idx} className="innings-card mb-4 border rounded">
                                            ...
                                            >
                                                <div className="fw-bold fs-6">{language === 'en' ? inn.team : (inn.team === match.teamA ? match.teamA : match.teamB)}</div>
                                ...
                                <div>
                                    ...
                                    <div className="bg-light p-3 rounded-3 small text-muted">
                                        <ul className="ps-3 mb-0" style={{ lineHeight: '1.8' }}>
                                            ...
                                            <li><strong>Bowling Limits:</strong>
                                                <ul className="ps-3 mt-1">
                                                    <li>Maximum <strong>{(match.totalOvers * 0.2).toFixed(0)} Overs</strong> per bowler.</li>
            ...
            <style>{`
                ...
                .result-alert { font-size: 0.9rem; color: var(--cric-green); font-weight: bold; border-bottom: 1px solid #eee; padding-bottom: 10px; }
